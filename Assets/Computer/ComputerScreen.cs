...
public class ComputerScreen : MonoBehaviour {
    ...
    void WriteTestText()
    {
        ...
        byte color = 15;
        string text = "This is a test message from the emulator itself. This has nothing todo with an  inner program and is generated by WriteTestText() method of the ComputerScreen  component.";
